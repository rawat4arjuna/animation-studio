...
async function GET() {
    try {
        const projects = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].project.findMany({
            orderBy: {
                updatedAt: 'desc'
            },
            include: {
...
async function POST(request) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].project.create({
            data: {
                name,
                description,
                fps
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c98cdd0._.js.map